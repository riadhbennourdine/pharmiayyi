...
const AdminPanel: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 mb-8"> {/* Changed main container style */}
      ...
      <div className="bg-gray-50 p-6 rounded-lg shadow-sm mb-6"> {/* Changed inner container style */}
        ...
        <button
          ...
          disabled={isLoading}
          className="bg-teal-600 hover:bg-teal-700 text-white font-bold py-2 px-4 rounded-lg transition-colors disabled:bg-teal-300 disabled:cursor-not-allowed" // Changed button style
        >
      ...
      {/* Preparateur-Pharmacien Assignment Section */}
      <div className="bg-gray-50 p-6 rounded-lg shadow-sm"> {/* Changed inner container style */}
        ...
        {preparateurs.length === 0 ? (
          ...
          <div className="overflow-x-auto mt-4">
            <table className="min-w-full bg-white border border-gray-200 rounded-lg"> {/* Changed table style */}
              <thead className="bg-gray-100"> {/* Changed table header style */}
                <tr>
              ...
              <tbody>
                {preparateurs.map((prep) => (
                  <tr key={prep._id?.toString()} className="border-b border-gray-200 last:border-b-0 hover:bg-gray-50"> {/* Changed row style */}
                    ...
                    <td className="py-3 px-4">
                      <select
                        ...
                        className="p-2 border border-gray-300 rounded-md w-full focus:ring-teal-500 focus:border-teal-500" // Changed select style
                    ...
                    <td className="py-3 px-4">
                      <button
                        ...
                        disabled={assignmentLoading}
                        className="bg-teal-600 hover:bg-teal-700 text-white font-bold py-1 px-3 rounded-lg transition-colors disabled:bg-teal-300 disabled:cursor-not-allowed" // Changed button style
                      >
